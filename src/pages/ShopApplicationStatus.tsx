...
const ShopApplicationStatus = () => {
  ...
  const getStatusMessage = (status: string) => {
    switch (status) {
      ...
      case 'approved':
        return 'Congratulations! Your shop application has been approved. Please check your email for payment instructions.';
      case 'rejected':
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2">${userApplication.price_range_min} - ${userApplication.price_range_max}</span>
                  </div>
                </div>
              </div>
