...
export const WelcomeCard = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-sm sm:max-w-md p-0 overflow-hidden border-0 bg-transparent max-h-[90vh] overflow-y-auto mx-2">
        <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-4 sm:p-6 pt-2 space-y-3 sm:space-y-4">
            ...
            <div className="bg-green-50 rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white rounded-lg hover:bg-gray-50 transition-colors border border-gray-100"
              >
                ...
                <div className="min-w-0">
                  <p className="font-semibold text-gray-800 text-sm sm:text-base">Join Discord</p>
                  <p className="text-xs text-gray-500 truncate">Disputes, questions, connect with vendors</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-semibold text-gray-800 text-sm sm:text-base">WhatsApp Channel</p>
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-semibold text-gray-800 text-sm sm:text-base">Follow on Facebook</p>
